...
+ Using Apollo Studio Server you can view the `schema introspection`  for more information about the types for troubleshooting or anything else. **Introspection needs to be enabled**. You can access the Apollo Studio Server by pointing your brwoswer to `http://localhost:3000/api/graphql`  
